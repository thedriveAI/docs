...
| Shortcut | Action |
|----------|--------|
| `Command+K` / `Ctrl+K` | Open command bar / Trigger AI organization |
| `Command+N` / `Ctrl+N` | Create new file |
| `Command+Shift+N` / `Ctrl+Shift+N` | Create new folder |
...
The command bar is a powerful feature for quick actions:
...
- **Action Confirmations**: Get notified when commands are executed
