...
Need to collect files from others? Use File Requests to create a secure upload link:

<Steps>
  <Step title="Create a File Request">
    Right-click on a folder and select **File Request**, or use Agent Mode: "Create a file request for the Client Documents folder."
  </Step>
  <Step title="Share the Link">
    Share the generated link with anyone you need files from.
  </Step>
  <Step title="Receive Files">
    Files uploaded through the link appear directly in your specified folder. Uploaders do not need a Drive AI account.
  </Step>
</Steps>

<Tip>
  File Requests are great for collecting documents from clients, vendors, or team members who do not use The Drive AI.
</Tip>
...
## Sharing with Agent Mode

Use natural language commands to manage sharing:
...
```
Give John editor access to the Contracts folder
```

```
Create a file request for the Client Onboarding folder
```

```
Remove Sarah's access to the Finance folder
```
...
<CardGroup cols={2}>
  <Card title="Agent Mode" icon="robot" href="/features/agent-mode">
    Manage file sharing with natural language commands.
  </Card>
